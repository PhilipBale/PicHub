angular.module('pichub.controllers', []).controller('AppCtrl', function($scope, $ionicModal, $timeout) {
	...
	$scope.updateItems = Photos.updateItems;
	...
	$scope.vote = Photos.voteForPhoto;
	/* Below also works if returning/special cases needed
	 $scope.vote = function(id, yesVote) {
	 Photos.voteForPhoto(id, yesVote);
	 };*/
	...
	//Example of chaining view functions to service functions
	$scope.capturePhoto = PhotoUpload.takePhoto;
